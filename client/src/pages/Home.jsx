...
const Home = ({ onNavigate = () => {} }) => {
  ...
  const roomTypes = [
    {
      title: 'Studio Room',
      icon: Bed,
      features: ['King Size Bed', 'Private Bathroom', 'AC & Fridge','TV'],
      price: '₵200/night'
    },
     {
  ...
  // Automatic slider images - high-quality guest house photos
  const sliderImages = [
    {
    ...
    },
    {
      ...
      alt: 'Spacious hotel lobby with comfortable seating'
    },

    {
      src: 'https://images.unsplash.com/photo-1590490360182-c33d57733427?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80',
